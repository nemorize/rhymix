...
namespace Rhymix\Modules\Dummy\Models;
...
class Config
{
	...
	public static function getConfig()
	{
		if (self::$_cache === null)
		{
			self::$_cache = ModuleModel::getModuleConfig('dummy') ?: new \stdClass;
		}
		return self::$_cache;
	}
	...
	public static function setConfig($config)
	{
		...
		$result = $oModuleController->insertModuleConfig('dummy', $config);
		if ($result->toBool())
		{
			self::$_cache = $config;
		}
